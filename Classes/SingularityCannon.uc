...
defaultproperties
{
     FireModeClass(0)=Class'TURM_U2Creatures.SingularityCannonFire'
     FireModeClass(1)=Class'TURM_U2Creatures.SingularityCannonAltFire'
     ...
     SelectSound=Sound'TURM_U2Creatures.WeaponsA_SingularityCannon.SC_Select'
     ...
     InventoryGroup=0
     PickupClass=Class'TURM_U2Creatures.SingularityCannonPickup'
     PlayerViewOffset=(X=4.000000,Y=5.500000,Z=-6.000000)
     PlayerViewPivot=(Yaw=-16384)
     BobDamping=2.250000
     AttachmentClass=Class'TURM_U2Creatures.SingularityCannonAttachment'
     IconMaterial=Texture'U2C_MiscTex.Icons.SmallIconSC'
     ...
     LightPeriod=3
     Mesh=SkeletalMesh'TURM_U2Creatures.SC_FP'
