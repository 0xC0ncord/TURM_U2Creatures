...
defaultproperties
{
     ...
     BeamEffectClass=Class'TURM_U2Creatures.RedLightningBolt'
     aimerror=350
     ...
     FireSound=Sound'TURM_U2Creatures.WeaponsA_LaserRifle.LR_Fire'
     ScoringValue=8
     Species=Class'TURM_U2Creatures.SPECIES_DrakkMedium'
     ...
     Mesh=SkeletalMesh'TURM_U2Creatures.DrakkMedium'
     DrawScale=0.550000
     PrePivot=(Z=-40.000000)
     Skins(0)=Shader'TURM_U2Creatures.Drakk.DrakkMediumBody2FX'
     Skins(1)=Shader'TURM_U2Creatures.Drakk.DrakkMediumBody1FX'
