...
function PostBeginPlay()
{
    ...
    if (SkinVar <= 0.20)
    {
        ...
        Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsMarine.MarineHeavyBody_RedFinal';
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsMarine.MarineHeavyLimbs_RedFinal';
    }
    else if (SkinVar <= 0.40 && SkinVar > 0.20)
    {
        Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsMarine.MarineHeavyBody_BlueFinal';
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsMarine.MarineHeavyLimbs_BlueFinal';
    }
    else if (SkinVar <= 0.60 && SkinVar > 0.40)
    {
        Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsMarine.MarineHeavyBody_GreenFinal';
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsMarine.MarineHeavyLimbs_GreenFinal';
    }
    else if (SkinVar <= 0.80 && SkinVar > 0.60)
    {
        Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsMarine.MarineHeavyBody_GoldFinal';
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsMarine.MarineHeavyLimbs_GoldFinal';
    }
    else
    {
        Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsMarine.MarineHeavyBody_DefaultFinal';
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsMarine.MarineHeavyLimbs_DefaultFinal';
    }
...
defaultproperties
{
     ...
     Species=Class'TURM_U2Creatures.SPECIES_MarineHeavy'
     Mesh=SkeletalMesh'TURM_U2Creatures.MarineHeavy'
     Skins(0)=Shader'TURM_U2Creatures.CharacterMaterialsMarine.MarineHeavyBody_DefaultFinal'
     Skins(1)=Shader'TURM_U2Creatures.CharacterMaterialsMarine.MarineHeavyLimbs_DefaultFinal'
