...
simulated function PostNetBeginPlay()
{
	...
	if (SkinVar <= 0.20)
	{
		Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapLightBody_RedFinal';
		Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapLightHelm_RedFinal';
	}	
	else if (SkinVar <= 0.40 && SkinVar > 0.20)
	{
		Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapLightBody_BlueFinal';
		Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapLightHelm_BlueFinal';
	}
	else if (SkinVar <= 0.60 && SkinVar > 0.40)
	{
		Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapLightBody_GreenFinal';
		Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapLightHelm_GreenFinal';
	}	
	else if (SkinVar <= 0.80 && SkinVar > 0.60)
	{
		Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapLightBody_GoldFinal';
		Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapLightHelm_GoldFinal';
	}
	else 
	{
		Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapLightBody_DefaultFinal';
		Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapLightHelm_DefaultFinal';
	}
...
defaultproperties
{
     ...
     Species=Class'TURM_U2Creatures.SPECIES_IzaLight'
     Mesh=SkeletalMesh'TURM_U2Creatures.MercJapLight'
     Skins(0)=Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapLightBody_BlueFinal'
     Skins(1)=Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapMediumHead_CaucasianFinal'
     Skins(2)=Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapLightHelm_BlueFinal'
     ...
     End Object
     KParams=KarmaParamsSkel'TURM_U2Creatures.IzanagiLight.PawnKParams'
