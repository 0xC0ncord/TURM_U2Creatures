...
defaultproperties
{
     ...
     Species=Class'TURM_U2Creatures.SPECIES_Izarian'
     Health=225
     Mesh=SkeletalMesh'TURM_U2Creatures.IzarianArmored'
     Skins(0)=Shader'TURM_U2Creatures.Izarian.IzarianBodyFX'
     Skins(1)=Shader'TURM_U2Creatures.Izarian.IzarianBodyFX'
     Skins(2)=Shader'TURM_U2Creatures.Izarian.IzarianHairFX'
     Skins(3)=Shader'TURM_U2Creatures.Izarian.IzarianHairFX'
     Skins(4)=Shader'TURM_U2Creatures.Izarian.IzarianArmAttachFX'
     Skins(5)=Shader'TURM_U2Creatures.Izarian.IzarianLegAttachFX'
