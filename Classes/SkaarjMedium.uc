...
simulated function PostNetBeginPlay()
{
    ...
    if (SkinVar <= 0.20)
    {
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumLower_DefaultFinal';
        Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumUpper_DefaultFinal';
        Skins[3] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumUpper_DefaultFinal';
    }
    else if (SkinVar <= 0.40 && SkinVar > 0.20)
    {
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumLower_BlueFinal';
        Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumUpper_BlueFinal';
        Skins[3] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumUpper_BlueFinal';
    }
    else if (SkinVar <= 0.60 && SkinVar > 0.40)
    {
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumLower_GoldFinal';
        Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumUpper_GoldFinal';
        Skins[3] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumUpper_GoldFinal';
    }
    else if (SkinVar <= 0.80 && SkinVar > 0.60)
    {
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumLower_GreenFinal';
        Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumUpper_GreenFinal';
        Skins[3] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumUpper_GreenFinal';
    }
    else
    {
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumLower_RedFinal';
        Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumUpper_RedFinal';
        Skins[3] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumUpper_RedFinal';
    }
...
defaultproperties
{
     ...
     FireSound=Sound'TURM_U2Creatures.WeaponsA_skaarjglove.SG_MediumFire'
     AmmunitionClass=Class'TURM_U2Creatures.SkaarjMediumAmmo'
     Species=Class'TURM_U2Creatures.SPECIES_SkaarjMedium'
     SoundDampening=0.480000
     Mesh=SkeletalMesh'TURM_U2Creatures.SkaarjMedium'
     Skins(0)=Texture'TURM_U2Creatures.skaarjglove'
     Skins(1)=Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumLower_DefaultFinal'
     Skins(2)=Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumUpper_DefaultFinal'
     Skins(3)=Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjMediumUpper_DefaultFinal'
     Mass=300.000000
