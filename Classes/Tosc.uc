...
function NotifyToscSoundWalkRight()
{
    ...
    PlaySound(sound'TURM_U2Creatures.Tosc.Tosc_Foot_Tri_Hit_3', SLOT_Interact, 12);
...
function NotifyToscSoundWalkLeft()
{
    ...
    PlaySound(sound'TURM_U2Creatures.Tosc.Tosc_Foot_Tri_Hit_4', SLOT_Interact, 12);
...
function PlayVictory()
{
    ...
    Acceleration = vect(0,0,0);
    bShotAnim = true;
        PlaySound(sound'TURM_U2Creatures.Tosc.Tosc_Taunt_2',SLOT_Interact);
...
simulated function CreateChargeUpEffect()
{
    ...
    PlaySound(sound'TURM_U2Creatures.WeaponsA_SingularityCannon.SC_PreFire', SLOT_Interact);
...
defaultproperties
{
     WeaponClassName(0)="TURM_U2Creatures.SingularityCannon"
     ClawDamage=232
     GrabDamage=184
     slice=Sound'TURM_U2Creatures.Tosc_Melee_1'
     ...
     MeleeSounds(0)=Sound'TURM_U2Creatures.Tosc.Tosc_Melee_1'
     MeleeSounds(1)=Sound'TURM_U2Creatures.Tosc.Tosc_Melee_2'
     MeleeSounds(2)=Sound'TURM_U2Creatures.Tosc.Tosc_Melee_3'
     MeleeSounds(3)=Sound'TURM_U2Creatures.Tosc.Tosc_Melee_4'
     MeleeSounds(4)=Sound'TURM_U2Creatures.Tosc.Tosc_Melee_5'
     MeleeSounds(5)=Sound'TURM_U2Creatures.Tosc.Tosc_Melee_6'
     MeleeSounds(6)=Sound'TURM_U2Creatures.Tosc.Tosc_Melee_7'
     MeleeSounds(7)=Sound'TURM_U2Creatures.Tosc.Tosc_Melee_8'
     MeleeSounds(8)=Sound'TURM_U2Creatures.Tosc.Tosc_Melee_9'
     MeleeSounds(9)=Sound'TURM_U2Creatures.Tosc.Tosc_Melee_10'
     MeleeSounds(10)=Sound'TURM_U2Creatures.Tosc.Tosc_Melee_11'
     MeleeSounds(11)=Sound'TURM_U2Creatures.Tosc.Tosc_Melee_12'
     BreakEffect=Class'XEffects.AlienBloodExplosion'
     ArmlessMesh=SkeletalMesh'TURM_U2Creatures.Tosc_NoArm'
     BeamDamage=25
     aimerror=400
     BeamDamageType=Class'XWeapons.DamTypeLinkShaft'
     MinChargeDistance=400.000000
     MaxChargeDistance=600.000000
     BeamEffectClass=Class'TURM_U2Creatures.ToscBeamEffect'
     DamageType=Class'XWeapons.DamTypeLinkShaft'
     bTryToWalk=True
     HitSound(0)=Sound'TURM_U2Creatures.Tosc_Hit_1'
     HitSound(1)=Sound'TURM_U2Creatures.Tosc_Hit_2'
     HitSound(2)=Sound'TURM_U2Creatures.Tosc_Hit_3'
     HitSound(3)=Sound'TURM_U2Creatures.Tosc_Hit_4'
     DeathSound(0)=Sound'TURM_U2Creatures.Tosc_Die_1'
     DeathSound(1)=Sound'TURM_U2Creatures.Tosc_Die_2'
     DeathSound(2)=Sound'TURM_U2Creatures.Tosc_Die_3'
     DeathSound(3)=Sound'TURM_U2Creatures.Tosc_Die_4'
     ChallengeSound(0)=Sound'TURM_U2Creatures.Tosc_Speak_1'
     ChallengeSound(1)=Sound'TURM_U2Creatures.Tosc_Speak_17'
     ChallengeSound(2)=Sound'TURM_U2Creatures.Tosc_Speak_12'
     ChallengeSound(3)=Sound'TURM_U2Creatures.Tosc_Speak_21'
     FireSound=Sound'TURM_U2Creatures.WeaponsA_SingularityCannon.SC_Fire'
     AmmunitionClass=Class'TURM_U2Creatures.ToscAmmo'
     ScoringValue=100
     Species=Class'TURM_U2Creatures.SPECIES_Tosc'
     ...
     IdleRestAnim="Idle03"
     IdleChatAnim="Idle04"
     AmbientSound=Sound'TURM_U2Creatures.Tosc.Tosc_Idle_4'
     Mesh=SkeletalMesh'TURM_U2Creatures.Tosc'
     PrePivot=(Z=4.000000)
     Skins(0)=Shader'TURM_U2Creatures.Tosc.toscsingcannonmat'
     Skins(1)=Shader'TURM_U2Creatures.Tosc.ToscHeadMAT'
     Skins(2)=Shader'TURM_U2Creatures.Tosc.tosclegsmat'
     Skins(3)=Shader'TURM_U2Creatures.Tosc.toscarmsmat'
     Skins(4)=Shader'TURM_U2Creatures.Tosc.toscarmsmat'
     Skins(5)=Shader'TURM_U2Creatures.Tosc.ToscHeadMAT'
