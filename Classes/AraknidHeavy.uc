...
//#exec OBJ LOAD file=..\Animations\TURM_U2Creatures.ukx
...
function ClawDamageTarget()
{
    ...
    {
        PlaySound(sound'TURM_U2Creatures.AraknidLightA_MeleeImpactPoint.MeleeImpactPoint1', SLOT_Interact);
    }
}
...
function RangedAttack(Actor A)
{
    ...
    {
        PlaySound(sound'TURM_U2Creatures.AraknidHeavyA_GenericC.Shockwave3', SLOT_Misc);
...
function PlayVictory()
{
    ...
    Acceleration = vect(0,0,0);
    bShotAnim = true;
        PlaySound(sound'TURM_U2Creatures.Idle1',SLOT_Interact);
    if ( FRand() < 0.50)
...
{
    //PlaySound(sound'TURM_U2Creatures.MovementSkitterWalkLoud', SLOT_Interact);
...
defaultproperties
{
     ...
     PodSounds(0)=Sound'TURM_U2Creatures.AraknidHeavyA_Misc.Pod1'
     PodSounds(1)=Sound'TURM_U2Creatures.AraknidHeavyA_Misc.Pod2'
     PodSounds(2)=Sound'TURM_U2Creatures.AraknidHeavyA_Misc.Pod3'
     PodSounds(3)=Sound'TURM_U2Creatures.AraknidHeavyA_Misc.Pod5'
     PodSounds(4)=Sound'TURM_U2Creatures.AraknidHeavyA_Misc.Pod6'
     SpermSounds(0)=Sound'TURM_U2Creatures.AraknidHeavyA_Misc.Sperm1'
     SpermSounds(1)=Sound'TURM_U2Creatures.AraknidHeavyA_Misc.Sperm2'
     ClawDamage=40
     MeleeSounds(0)=Sound'TURM_U2Creatures.AraknidHeavyA_MeleeMotion.MeleeMotion1'
     MeleeSounds(1)=Sound'TURM_U2Creatures.AraknidHeavyA_MeleeMotion.MeleeMotion2'
     MeleeSounds(2)=Sound'TURM_U2Creatures.AraknidHeavyA_MeleeMotion.MeleeMotion3'
     MeleeSounds(3)=Sound'TURM_U2Creatures.AraknidHeavyA_MeleeMotion.MeleeMotion4'
     MeleeSounds(4)=Sound'TURM_U2Creatures.AraknidHeavyA_MeleeMotion.MeleeMotion5'
     MeleeSounds(5)=Sound'TURM_U2Creatures.AraknidHeavyA_MeleeMotion.MeleeMotion6'
     StepSounds(0)=Sound'TURM_U2Creatures.AraknidHeavyA_Move.Move1'
     StepSounds(1)=Sound'TURM_U2Creatures.AraknidHeavyA_Move.Move2'
     StepSounds(2)=Sound'TURM_U2Creatures.AraknidHeavyA_Move.Move3'
     StepSounds(3)=Sound'TURM_U2Creatures.AraknidHeavyA_Move.Move4'
     LandSounds(0)=Sound'TURM_U2Creatures.AraknidHeavyA_Move.Land1'
     LandSounds(1)=Sound'TURM_U2Creatures.AraknidHeavyA_Move.Land2'
     LandSounds(2)=Sound'TURM_U2Creatures.AraknidHeavyA_Move.Land3'
     LandSounds(3)=Sound'TURM_U2Creatures.AraknidHeavyA_Move.Land4'
     LandSounds(4)=Sound'TURM_U2Creatures.AraknidHeavyA_Move.Land5'
     LandSounds(5)=Sound'TURM_U2Creatures.AraknidHeavyA_Move.Land6'
     LungeDamage=75
     ...
     bBoss=True
     HitSound(0)=Sound'TURM_U2Creatures.AraknidHeavyA_HitSoft.Hit1'
     HitSound(1)=Sound'TURM_U2Creatures.AraknidHeavyA_HitSoft.Hit2'
     HitSound(2)=Sound'TURM_U2Creatures.AraknidHeavyA_HitSoft.Hit3'
     HitSound(3)=Sound'TURM_U2Creatures.AraknidHeavyA_HitHard.Hit2'
     DeathSound(0)=Sound'TURM_U2Creatures.AraknidHeavyA_DieHard.DieHard1'
     DeathSound(1)=Sound'TURM_U2Creatures.AraknidHeavyA_DieHard.DieHard2'
     DeathSound(2)=Sound'TURM_U2Creatures.AraknidHeavyA_DieHard.DieHard3'
     DeathSound(3)=Sound'TURM_U2Creatures.AraknidHeavyA_Idle.Idle3'
     ChallengeSound(0)=Sound'TURM_U2Creatures.AraknidHeavyA_Acquire.Acquire1'
     ChallengeSound(1)=Sound'TURM_U2Creatures.AraknidHeavyA_Acquire.Acquire2'
     ChallengeSound(2)=Sound'TURM_U2Creatures.AraknidHeavyA_Acquire.Acquire5'
     ChallengeSound(3)=Sound'TURM_U2Creatures.AraknidHeavyA_Acquire.Acquire6'
     AmmunitionClass=Class'TURM_U2Creatures.AraknidHeavyAmmo'
     Species=Class'TURM_U2Creatures.SPECIES_AraknidHeavy'
     GibGroupClass=Class'TURM_U2Creatures.AraknidHeavyGibGroup'
     GroundSpeed=245.000000
     Health=2000
     ControllerClass=Class'TURM_U2Creatures.U2AraknidHeavyController'
     Mesh=SkeletalMesh'TURM_U2Creatures.AraknidHeavy'
     DrawScale=1.000000
     PrePivot=(X=10.000000,Z=0.000000)
     Skins(0)=Shader'TURM_U2Creatures.Araknid.AraknidHeavyBody1FX'
     Skins(1)=Shader'TURM_U2Creatures.Araknid.araknidheavybody2FX'
