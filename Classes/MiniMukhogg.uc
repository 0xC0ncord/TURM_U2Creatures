...
function RamDamageTarget()
{
	if ( MeleeDamageTarget(RamDamage, (45000 * Normal(Controller.Target.Location - Location))) )//2500
		if (FRand() < 0.5)
			PlaySound(sound'TURM_U2Creatures.Headbutt1', SLOT_Interact);			
		else
			PlaySound(sound'TURM_U2Creatures.Headbutt2', SLOT_Interact);
}	
...
defaultproperties
{
     ...
     Species=Class'TURM_U2Creatures.SPECIES_MiniMukhogg'
     ...
     End Object
     KParams=KarmaParamsSkel'TURM_U2Creatures.MiniMukhogg.PawnKParams'
