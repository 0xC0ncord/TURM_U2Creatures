...
defaultproperties
{
     ...
     Species=Class'TURM_U2Creatures.SPECIES_Marshal'
     Mesh=SkeletalMesh'TURM_U2Creatures.Marshal'
     Skins(0)=FinalBlend'TURM_U2Creatures.CharacterMaterials.PlayerLimbs_DefaultFinalBlend'
     Skins(1)=FinalBlend'TURM_U2Creatures.CharacterMaterials.PlayerTorso_DefaultFinalBlend'
     Skins(2)=FinalBlend'TURM_U2Creatures.CharacterMaterials.PlayerTorso_DefaultFinalBlend'
