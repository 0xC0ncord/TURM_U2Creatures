...
simulated function PostNetBeginPlay()
{
	...
	if (SkinVar <= 0.20)
	{
		Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapHeavy1_REDFinal';
		Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapHeavy0_REDFinal';
	}	
	else if (SkinVar <= 0.40 && SkinVar > 0.20)
	{
		Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapHeavy1_BLUEFinal';
		Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapHeavy0_BLUEFinal';
	}
	else if (SkinVar <= 0.60 && SkinVar > 0.40)
	{
		Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapHeavy1_GREENFinal';
		Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapHeavy0_GREENFinal';
	}	
	else if (SkinVar <= 0.80 && SkinVar > 0.60)
	{
		Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapHeavy1_GOLDFinal';
		Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapHeavy0_GOLDFinal';
	}
	else 
	{
		Skins[0] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapHeavy1Final';
		Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapHeavy0Final';
	}
	

	if (FaceVar <= 0.33)
		Skins[3] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapMediumHead_BlackFinal';
	else if (FaceVar <= 0.66)
		Skins[3] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapMediumHead_PhillipinoFinal';
	else
		Skins[3] = Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapMediumHead_ScarFinal';
...
defaultproperties
{
     ...
     Species=Class'TURM_U2Creatures.SPECIES_IzaHeavy'
     Mesh=SkeletalMesh'TURM_U2Creatures.MercJapHeavy'
     Skins(0)=Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapHeavy1_BLUEFinal'
     Skins(1)=Shader'TURM_U2Creatures.CharacterMaterialsIzanagi.MercJapHeavy0_BLUEFinal'
     ...
     End Object
     KParams=KarmaParamsSkel'TURM_U2Creatures.IzanagiHeavy.PawnKParams'
