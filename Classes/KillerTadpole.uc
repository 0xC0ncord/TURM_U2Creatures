...
simulated function PlayDying(class<DamageType> DamageType, vector HitLoc)
{
    ...
    {
        PlaySound(sound'TURM_U2Creatures.DieSoft1', SLOT_Talk, 4 * TransientSoundVolume);
...
defaultproperties
{
     BiteDamage=10
     bCheckWater=True
     HitSound(0)=Sound'TURM_U2Creatures.KillerTadpoleA_HitHard.Hit1'
     HitSound(1)=Sound'TURM_U2Creatures.KillerTadpoleA_HitHard.Hit2'
     HitSound(2)=Sound'TURM_U2Creatures.KillerTadpoleA_HitHard.Hit3'
     HitSound(3)=Sound'TURM_U2Creatures.KillerTadpoleA_HitHard.Hit1'
     DeathSound(0)=Sound'TURM_U2Creatures.KillerTadpoleA_DieSoft.DieSoft1'
     DeathSound(1)=Sound'TURM_U2Creatures.KillerTadpoleA_DieSoft.DieSoft2'
     DeathSound(2)=Sound'TURM_U2Creatures.KillerTadpoleA_DieSoft.DieSoft3'
     DeathSound(3)=Sound'TURM_U2Creatures.KillerTadpoleA_Move.Idle2'
     ChallengeSound(0)=Sound'TURM_U2Creatures.KillerTadpoleA_Move.Idle1'
     ChallengeSound(1)=Sound'TURM_U2Creatures.KillerTadpoleA_Move.Idle3'
     ChallengeSound(2)=Sound'TURM_U2Creatures.KillerTadpoleA_Move.Idle4'
     ChallengeSound(3)=Sound'TURM_U2Creatures.KillerTadpoleA_Move.Idle5'
     FireSound=Sound'TURM_U2Creatures.KillerTadpoleA_MeleeMotion.MeleeAttack1'
     Species=Class'TURM_U2Creatures.SPECIES_Tadpole'
     ...
     AmbientSound=Sound'TURM_U2Creatures.KillerTadpoleA_Move.Idle2'
     Mesh=SkeletalMesh'TURM_U2Creatures.KillerTadpole'
     PrePivot=(X=15.000000)
     Skins(0)=Texture'TURM_U2Creatures.KillerTadpole'
