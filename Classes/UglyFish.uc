...
simulated function PlayDying(class<DamageType> DamageType, vector HitLoc)
{
    ...
    {
        PlaySound(sound'TURM_U2Creatures.UglyFishA_DieSoft.DieSoft1', SLOT_Talk, 4 * TransientSoundVolume);
...
{
     BiteDamage=25
     HitSound(0)=Sound'TURM_U2Creatures.UglyFishA_HitSoft.Hit1'
     HitSound(1)=Sound'TURM_U2Creatures.UglyFishA_HitSoft.Hit2'
     HitSound(2)=Sound'TURM_U2Creatures.UglyFishA_HitSoft.Hit3'
     HitSound(3)=Sound'TURM_U2Creatures.UglyFishA_HitSoft.Hit1'
     DeathSound(0)=Sound'TURM_U2Creatures.UglyFishA_DieSoft.DieSoft1'
     DeathSound(1)=Sound'TURM_U2Creatures.UglyFishA_DieSoft.DieSoft2'
     DeathSound(2)=Sound'TURM_U2Creatures.UglyFishA_DieSoft.DieSoft3'
     DeathSound(3)=Sound'TURM_U2Creatures.UglyFishA_Move.Idle2'
     ChallengeSound(0)=Sound'TURM_U2Creatures.UglyFishA_Move.Idle1'
     ChallengeSound(1)=Sound'TURM_U2Creatures.UglyFishA_Move.Idle3'
     ChallengeSound(2)=Sound'TURM_U2Creatures.UglyFishA_Move.Idle4'
     ChallengeSound(3)=Sound'TURM_U2Creatures.UglyFishA_Move.Idle5'
     FireSound=Sound'TURM_U2Creatures.UglyFishA_MeleeDamage.MeleeAttack1'
     Species=Class'TURM_U2Creatures.SPECIES_Ugly'
     ...
     AmbientSound=Sound'TURM_U2Creatures.UglyFishA_Move.Idle2'
     Mesh=SkeletalMesh'TURM_U2Creatures.UglyFish'
     PrePivot=(X=-100.000000)
     Skins(0)=Texture'TURM_U2Creatures.Uglyfish1'
     Skins(1)=Texture'TURM_U2Creatures.Uglyfish1'
