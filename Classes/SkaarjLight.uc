...
//#exec OBJ LOAD file=..\Sounds\TURM_U2Creatures.uax
#exec OBJ LOAD file=..\Sounds\TURM_U2Creatures.uax
#exec OBJ LOAD file=..\Textures\TURM_U2Creatures.utx
...
simulated function PostNetBeginPlay()
{
    ...
    if (SkinVar <= 0.20)
    {
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightLegs_DefaultFinal';
        Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightArms_DefaultFinal';
        Skins[3] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightChest_DefaultFinal';
    }
    else if (SkinVar <= 0.40 && SkinVar > 0.20)
    {
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightLegs_BlueFinal';
        Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightArms_BlueFinal';
        Skins[3] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightChest_BlueFinal';
    }
    else if (SkinVar <= 0.60 && SkinVar > 0.40)
    {
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightLegs_GoldFinal';
        Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightArms_GoldFinal';
        Skins[3] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightChest_GoldFinal';
    }
    else if (SkinVar <= 0.80 && SkinVar > 0.60)
    {
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightLegs_GreenFinal';
        Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightArms_GreenFinal';
        Skins[3] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightChest_GreenFinal';
    }
    else
    {
        Skins[1] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightLegs_RedFinal';
        Skins[2] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightArms_RedFinal';
        Skins[3] = Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightChest_RedFinal';
    }
}
...
function StartLeapOld()
{
    ...
    if (Controller != None && Controller.Enemy != None)
    {
        ...
        PlaySound(Sound'TURM_U2Creatures.SkaarjA_Leap.Flip', SLOT_Interact);
    }
    SetPhysics(PHYS_Falling);
    //Controller.bPreparingMove = true;
}
...
defaultproperties
{
     ...
     KickDamage=15
     HeadButtDamage=18
     Claw=Sound'TURM_U2Creatures.SkaarjA_MeleeDamage.ClawHit2'
     slice=Sound'TURM_U2Creatures.SkaarjA_MeleeDamage.ClawHit1'
     ...
     MeleeSounds(0)=Sound'TURM_U2Creatures.SkaarjA_Misc.MeleeAttack1'
     MeleeSounds(1)=Sound'TURM_U2Creatures.SkaarjA_Misc.MeleeAttack2'
     MeleeSounds(2)=Sound'TURM_U2Creatures.SkaarjA_Misc.MeleeAttack3'
     MeleeSounds(3)=Sound'TURM_U2Creatures.SkaarjA_Misc.MeleeAttack4'
     TauntSounds(0)=Sound'TURM_U2Creatures.SkaarjA_KillsTaunts.Taunt1'
     TauntSounds(1)=Sound'TURM_U2Creatures.SkaarjA_KillsTaunts.Taunt2'
     TauntSounds(2)=Sound'TURM_U2Creatures.SkaarjA_KillsTaunts.Taunt3'
     TauntSounds(3)=Sound'TURM_U2Creatures.SkaarjA_KillsTaunts.Taunt4'
     TauntSounds(4)=Sound'TURM_U2Creatures.SkaarjA_KillsTaunts.Taunt5'
     ...
     DefensiveSounds(0)="TURM_U2Creatures.WeaponsA_BulletImpacts.BulletMetal01"
     DefensiveSounds(1)="TURM_U2Creatures.WeaponsA_BulletImpacts.BulletMetal02"
     DefensiveSounds(2)="TURM_U2Creatures.WeaponsA_BulletImpacts.BulletMetal03"
     DefensiveSounds(3)="TURM_U2Creatures.WeaponsA_BulletImpacts.BulletMetal04"
     DefensiveRicochetSounds(0)="TURM_U2Creatures.WeaponsA_BulletImpacts.RicMetal01"
     DefensiveRicochetSounds(1)="TURM_U2Creatures.WeaponsA_BulletImpacts.RicMetal09"
     DefensiveRicochetSounds(2)="TURM_U2Creatures.WeaponsA_BulletImpacts.RicMetal13"
     DefensiveRicochetSounds(3)="TURM_U2Creatures.WeaponsA_BulletImpacts.RicMetal14"
     DefensiveEffect=Class'TURM_U2Creatures.SkaarjSparks'
     bCanDefend=True
     ProxyRadius=256.000000
     ProxyHeight=128.000000
     AmbientSoundStrings(0)="TURM_U2Creatures.SkaarjA_Misc.Ambient1"
     AmbientSoundStrings(1)="TURM_U2Creatures.SkaarjA_Misc.Ambient2"
     AmbientSoundStrings(2)="TURM_U2Creatures.SkaarjA_Misc.Ambient3"
     AmbientSoundStrings(3)="TURM_U2Creatures.SkaarjA_Misc.Ambient4"
     ...
     CollisionTesterClass=Class'TURM_U2Creatures.CollisionTesterSkaarjLight'
     BonePitch="Bip01 Spine1"
     ...
     HitSound(0)=Sound'TURM_U2Creatures.SkaarjA_HitSoft.Hit1'
     HitSound(1)=Sound'TURM_U2Creatures.SkaarjA_HitSoft.Hit2'
     HitSound(2)=Sound'TURM_U2Creatures.SkaarjA_HitSoft.Hit3'
     HitSound(3)=Sound'TURM_U2Creatures.SkaarjA_HitSoft.Hit4'
     DeathSound(0)=Sound'TURM_U2Creatures.SkaarjA_DieHard.DieHard1'
     DeathSound(1)=Sound'TURM_U2Creatures.SkaarjA_DieHard.DieHard2'
     DeathSound(2)=Sound'TURM_U2Creatures.SkaarjA_DieHard.DieHard3'
     DeathSound(3)=Sound'TURM_U2Creatures.SkaarjA_DieSoft.DieSoft1'
     ChallengeSound(0)=Sound'TURM_U2Creatures.SkaarjA_Acquire.SeeEnemy1'
     ChallengeSound(1)=Sound'TURM_U2Creatures.SkaarjA_Acquire.SeeEnemy2'
     ChallengeSound(2)=Sound'TURM_U2Creatures.SkaarjA_Acquire.SeeEnemy3'
     ChallengeSound(3)=Sound'TURM_U2Creatures.SkaarjA_Misc.IdleChat3'
     FireSound=Sound'TURM_U2Creatures.WeaponsA_skaarjglove.SG_LightFire'
     AmmunitionClass=Class'TURM_U2Creatures.SkaarjLightAmmo'
     ScoringValue=5
     Species=Class'TURM_U2Creatures.SPECIES_SkaarjLight'
     GibGroupClass=Class'TURM_U2Creatures.SkaarjGibGroup'
     ...
     ControllerClass=Class'TURM_U2Creatures.U2SkaarjController'
     ...
     AmbientSound=Sound'TURM_U2Creatures.SkaarjA_Misc.Ambient1'
     Mesh=SkeletalMesh'TURM_U2Creatures.SkaarjLight'
     DrawScale=0.700000
     PrePivot=(Z=-4.000000)
     Skins(0)=Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightHair_AllFinal'
     Skins(1)=Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightLegs_DefaultFinal'
     Skins(2)=Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightArms_DefaultFinal'
     Skins(3)=Shader'TURM_U2Creatures.CharacterMaterialsSkaarj.SkaarjLightChest_DefaultFinal'
