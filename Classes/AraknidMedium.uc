...
function ClawDamageTarget()
{
    ...
    {
        PlaySound(sound'TURM_U2Creatures.MeleeImpactPoint1', SLOT_Interact);
    }
}
...
function RangedAttack(Actor A)
{
    ...
    /*else if ( (Level.TimeSeconds - LastLeapTime >= MinLeapRefireDelay) && FRand() <= LeapOdds && Physics != PHYS_Falling && (Dist < LungeRange + CollisionRadius + A.CollisionRadius) && (Dist >= LungeRangeMin) )
    {
        ...
        SetAnimAction('Jump01_Start');
        bShotAnim = true;
        PlaySound(sound'TURM_U2Creatures.Leap.Leap1', SLOT_Interact);
        //bLunging = true;
        //Enable('Bump');//800
...
{
     ClawDamage=20
     MeleeSounds(0)=Sound'TURM_U2Creatures.AraknidMediumA_MeleeMotion.MeleeMotion1'
     MeleeSounds(1)=Sound'TURM_U2Creatures.AraknidMediumA_MeleeMotion.MeleeMotion2'
     MeleeSounds(2)=Sound'TURM_U2Creatures.AraknidMediumA_MeleeMotion.MeleeMotion3'
     MeleeSounds(3)=Sound'TURM_U2Creatures.AraknidMediumA_MeleeMotion.MeleeMotion4'
     StepSounds(0)=Sound'TURM_U2Creatures.AraknidMediumA_Move.Move1'
     StepSounds(1)=Sound'TURM_U2Creatures.AraknidMediumA_Move.Move2'
     LandSounds(0)=Sound'TURM_U2Creatures.AraknidMediumA_Move.Land1'
     LandSounds(1)=Sound'TURM_U2Creatures.AraknidMediumA_Move.Land2'
     LandThumpSound=Sound'TURM_U2Creatures.AraknidMediumA_Move.LandThump1'
     LeapImpactSounds(0)=Sound'TURM_U2Creatures.AraknidMediumA_LeapImpact.LeapImpact1'
     LeapImpactSounds(1)=Sound'TURM_U2Creatures.AraknidMediumA_LeapImpact.LeapImpact2'
     ...
     HitSound(0)=Sound'TURM_U2Creatures.AraknidMediumA_HitSoft.HitSoft1'
     HitSound(1)=Sound'TURM_U2Creatures.AraknidMediumA_HitSoft.HitSoft2'
     HitSound(2)=Sound'TURM_U2Creatures.AraknidMediumA_HitHard.HitHard1'
     HitSound(3)=Sound'TURM_U2Creatures.AraknidMediumA_HitHard.HitHard2'
     DeathSound(0)=Sound'TURM_U2Creatures.AraknidMediumA_DieHard.DieHard1'
     DeathSound(1)=Sound'TURM_U2Creatures.AraknidMediumA_DieHard.DieHard2'
     DeathSound(2)=Sound'TURM_U2Creatures.AraknidMediumA_DieHard.DieHard3'
     DeathSound(3)=Sound'TURM_U2Creatures.AraknidMediumA_Idle.Idle2'
     ChallengeSound(0)=Sound'TURM_U2Creatures.AraknidMediumA_Idle.Idle1'
     ChallengeSound(1)=Sound'TURM_U2Creatures.AraknidMediumA_Idle.Idle2'
     ChallengeSound(2)=Sound'TURM_U2Creatures.AraknidMediumA_Idle.Idle1'
     ChallengeSound(3)=Sound'TURM_U2Creatures.AraknidMediumA_Idle.Idle2'
     FireSound=None
     AmmunitionClass=Class'TURM_U2Creatures.AraknidMediumAmmo'
     ScoringValue=5
     Species=Class'TURM_U2Creatures.SPECIES_AraknidMedium'
     GibGroupClass=Class'TURM_U2Creatures.AraknidMediumGibGroup'
     ...
     Mesh=SkeletalMesh'TURM_U2Creatures.AraknidMedium'
     DrawScale=0.700000
     PrePivot=(X=-10.000000,Z=5.000000)
     Skins(0)=Shader'TURM_U2Creatures.Araknid.AraknidMedium1FX'
     Skins(1)=Shader'TURM_U2Creatures.Araknid.AraknidMedium2FX'
     Skins(2)=Shader'TURM_U2Creatures.Araknid.araknidheavybody3FX'
