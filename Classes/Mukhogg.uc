...
simulated function Step()
{
    ...
    Super.Step();
    if (FRand() < 0.25)
        PlaySound(sound'TURM_U2Creatures.MukhoggA_Footstep.FootStep1', SLOT_Interact);
    else if (FRand() < 0.5)
        PlaySound(sound'TURM_U2Creatures.MukhoggA_Footstep.FootStep2', SLOT_Interact);
    else if (FRand() < 0.75)
        PlaySound(sound'TURM_U2Creatures.MukhoggA_Footstep.FootStep3', SLOT_Interact);
    else if (FRand() < 1.0)
        PlaySound(sound'TURM_U2Creatures.MukhoggA_Footstep.FootStep4', SLOT_Interact);
}
...
function PlayVictory()
{
    ...
    bShotAnim = true;
        PlaySound(sound'TURM_U2Creatures.MukhoggA_Misc.RevUp',SLOT_Interact);
    SetAnimAction('RevUp');
...
function RangedAttack(Actor A)
{
    ...
    if ( Dist <= MeleeRange + CollisionRadius + A.CollisionRadius )
    {
        ...
        if (FRand() <= 0.33 )
            PlaySound(sound'TURM_U2Creatures.MukhoggA_MeleeDamage.MeleeAttack1', SLOT_Interact);
        else if (FRand() <= 0.66 )
            PlaySound(sound'TURM_U2Creatures.MukhoggA_MeleeDamage.MeleeAttack2', SLOT_Interact);
        else
            PlaySound(sound'TURM_U2Creatures.MukhoggA_MeleeDamage.MeleeAttack3', SLOT_Interact);
...
defaultproperties
{
     ...
     bTryToWalk=True
     HitSound(0)=Sound'TURM_U2Creatures.MukhoggA_HitSoft.Hit1'
     HitSound(1)=Sound'TURM_U2Creatures.MukhoggA_HitSoft.Hit2'
     HitSound(2)=Sound'TURM_U2Creatures.MukhoggA_HitSoft.Hit1'
     HitSound(3)=Sound'TURM_U2Creatures.MukhoggA_HitSoft.Hit2'
     DeathSound(0)=Sound'TURM_U2Creatures.MukhoggA_DieSoft.DieSoft1'
     DeathSound(1)=Sound'TURM_U2Creatures.MukhoggA_DieSoft.DieSoft2'
     DeathSound(2)=Sound'TURM_U2Creatures.MukhoggA_HitSoft.Hit1'
     DeathSound(3)=Sound'TURM_U2Creatures.MukhoggA_DieSoft.DieSoft1'
     ChallengeSound(0)=Sound'TURM_U2Creatures.MukhoggA_Acquire.SeeEnemy1'
     ChallengeSound(1)=Sound'TURM_U2Creatures.MukhoggA_Misc.RevUp'
     ChallengeSound(2)=Sound'TURM_U2Creatures.MukhoggA_Misc.Getup1'
     ChallengeSound(3)=Sound'TURM_U2Creatures.MukhoggA_Misc.Getup2'
     FireSound=Sound'TURM_U2Creatures.MukhoggA_MeleeDamage.MeleeAttack1'
     ScoringValue=5
     Species=Class'TURM_U2Creatures.SPECIES_Mukhogg'
     ...
     ControllerClass=Class'TURM_U2Creatures.U2BasicMeleeMonsterController'
     ...
     Mesh=SkeletalMesh'TURM_U2Creatures.Mukhogg'
     DrawScale=0.500000
     PrePivot=(Z=10.000000)
     Skins(0)=Texture'TURM_U2Creatures.MukhoggBody'
     Skins(1)=Texture'TURM_U2Creatures.MukhoggTeeth'
