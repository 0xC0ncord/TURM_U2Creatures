...
function PlayVictory()
{
    ...
    bShotAnim = true;
        PlaySound(sound'TURM_U2Creatures.RammerA_Misc.Idle6',SLOT_Interact);
...
function RamDamageTarget()
{
    if ( MeleeDamageTarget(RamDamage, (25000 * Normal(Controller.Target.Location - Location))) )
        if (FRand() < 0.5)
            PlaySound(sound'TURM_U2Creatures.RammerA_MeleeDamage.Headbutt1', SLOT_Interact);
        else
            PlaySound(sound'TURM_U2Creatures.RammerA_MeleeDamage.Headbutt2', SLOT_Interact);
}
...
function RangedAttack(Actor A)
{
    ...
    if ( Dist <= MeleeRange + CollisionRadius + A.CollisionRadius )
    {
        ...
        if (FRand() < 0.14 )
            PlaySound(sound'TURM_U2Creatures.RammerA_Misc.MeleeAttack1', SLOT_Interact);
        else if (FRand() < 0.28 )
            PlaySound(sound'TURM_U2Creatures.RammerA_Misc.MeleeAttack2', SLOT_Interact);
        else if (FRand() < 0.42 )
            PlaySound(sound'TURM_U2Creatures.RammerA_Misc.MeleeAttack3', SLOT_Interact);
        else if (FRand() < 0.56 )
            PlaySound(sound'TURM_U2Creatures.RammerA_Misc.MeleeAttack4', SLOT_Interact);
        else if (FRand() < 0.7 )
            PlaySound(sound'TURM_U2Creatures.RammerA_Misc.MeleeAttack5', SLOT_Interact);
        else if (FRand() < 0.84 )
            PlaySound(sound'TURM_U2Creatures.RammerA_Misc.MeleeAttack6', SLOT_Interact);
        else
            PlaySound(sound'TURM_U2Creatures.RammerA_Misc.MeleeAttack7', SLOT_Interact);
...
{
     RamDamage=50
     StepSounds(0)=Sound'TURM_U2Creatures.RammerA_Footstep.Footstep1'
     StepSounds(1)=Sound'TURM_U2Creatures.RammerA_Footstep.Footstep2'
     StepSounds(2)=Sound'TURM_U2Creatures.RammerA_Footstep.FootStep3'
     StepSounds(3)=Sound'TURM_U2Creatures.RammerA_Footstep.Footstep4'
     StepShakeRadius=1024.000000
     StepShakeMagnitude=5.000000
     StepShakeDuration=0.400000
     bCanDodge=False
     HitSound(0)=Sound'TURM_U2Creatures.RammerA_HitSoft.Hit1'
     HitSound(1)=Sound'TURM_U2Creatures.RammerA_HitSoft.Hit2'
     HitSound(2)=Sound'TURM_U2Creatures.RammerA_HitSoft.Hit3'
     HitSound(3)=Sound'TURM_U2Creatures.RammerA_HitSoft.Hit4'
     DeathSound(0)=Sound'TURM_U2Creatures.RammerA_DieSoft.DieSoft1'
     DeathSound(1)=Sound'TURM_U2Creatures.RammerA_DieSoft.DieSoft2'
     DeathSound(2)=Sound'TURM_U2Creatures.RammerA_HitSoft.Hit5'
     DeathSound(3)=Sound'TURM_U2Creatures.RammerA_DieSoft.DieSoft1'
     ChallengeSound(0)=Sound'TURM_U2Creatures.RammerA_Acquire.SeeEnemy1'
     ChallengeSound(1)=Sound'TURM_U2Creatures.RammerA_Acquire.SeeEnemy2'
     ChallengeSound(2)=Sound'TURM_U2Creatures.RammerA_Acquire.SeeEnemy3'
     ChallengeSound(3)=Sound'TURM_U2Creatures.RammerA_Acquire.SeeEnemy4'
     FireSound=Sound'TURM_U2Creatures.RammerA_Misc.MeleeAttack1'
     ScoringValue=5
     Species=Class'TURM_U2Creatures.SPECIES_Rammer'
     GibGroupClass=Class'TURM_U2Creatures.GenericGibGroup'
     ...
     Mesh=SkeletalMesh'TURM_U2Creatures.Rammer'
     DrawScale=1.500000
     PrePivot=(Z=38.000000)
     Skins(0)=Texture'TURM_U2Creatures.Rammer'
