...
function RangedAttack(Actor A)
{
    ...
    /*else if ( FRand() <= LeapOdds && VSize(A.Location - Location) <= LungeRange + CollisionRadius + A.CollisionRadius )
    {
        ...
        PlaySound(sound'TURM_U2Creatures.MeleeImpactPoint2', SLOT_Interact);
        bLunging = true;
        Enable('Bump');
        //SetAnimAction('Lunge');
...
defaultproperties
{
     ...
     HitSound(0)=Sound'TURM_U2Creatures.AraknidLightA_HitSoft.HitSoft1'
     HitSound(1)=Sound'TURM_U2Creatures.AraknidLightA_HitSoft.HitSoft2'
     HitSound(2)=Sound'TURM_U2Creatures.AraknidLightA_HitHard.HitHard1'
     HitSound(3)=Sound'TURM_U2Creatures.AraknidLightA_HitHard.HitHard2'
     DeathSound(0)=Sound'TURM_U2Creatures.AraknidLightA_DieHard.DieHard1'
     DeathSound(1)=Sound'TURM_U2Creatures.AraknidLightA_DieHard.DieHard2'
     DeathSound(2)=Sound'TURM_U2Creatures.AraknidLightA_DieHard.DieHard3'
     DeathSound(3)=Sound'TURM_U2Creatures.AraknidLightA_Idle.Idle2'
     ChallengeSound(0)=Sound'TURM_U2Creatures.AraknidLightA_Idle.Idle1'
     ChallengeSound(1)=Sound'TURM_U2Creatures.AraknidLightA_Idle.Idle2'
     ChallengeSound(2)=Sound'TURM_U2Creatures.AraknidLightA_Idle.Idle1'
     ChallengeSound(3)=Sound'TURM_U2Creatures.AraknidLightA_Idle.Idle2'
     FireSound=Sound'TURM_U2Creatures.AraknidLightA_MeleeImpactPoint.MeleeImpactPoint1'
     AmmunitionClass=Class'TURM_U2Creatures.AraknidLightAmmo'
     Species=Class'TURM_U2Creatures.SPECIES_AraknidLight'
     GibGroupClass=Class'TURM_U2Creatures.AraknidLightGibGroup'
     ...
     IdleRestAnim="Idle04"
     IdleChatAnim="look"
     Mesh=SkeletalMesh'TURM_U2Creatures.AraknidLight'
     DrawScale=0.600000
     PrePivot=(Z=-19.000000)
     Skins(0)=Texture'TURM_U2Creatures.AraknidLight'
