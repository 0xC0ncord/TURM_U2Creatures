...
simulated function PostNetBeginPlay()
{
    ...
    if (SkinVar <= 0.25)
    {
            Skins[0] = Texture'TURM_U2Creatures.FlyingSnakeCorpse';
            Skins[1] = Shader'TURM_U2Creatures.FlyingSnakeCorpseWings';
    }
    else
    {
            Skins[0] = Texture'TURM_U2Creatures.FlyingSnake';
            Skins[1] = Shader'TURM_U2Creatures.FlyingSnakeWings';
    }
...
defaultproperties
{
     ...
     HitSound(0)=Sound'TURM_U2Creatures.FlyingSnakeA_HitSoft.Hit1'
     HitSound(1)=Sound'TURM_U2Creatures.FlyingSnakeA_HitHard.Hit2'
     HitSound(2)=Sound'TURM_U2Creatures.FlyingSnakeA_HitSoft.Hit1'
     HitSound(3)=Sound'TURM_U2Creatures.FlyingSnakeA_HitHard.Hit2'
     DeathSound(0)=Sound'TURM_U2Creatures.FlyingSnakeA_DieSoft.DieSoft1'
     DeathSound(1)=Sound'TURM_U2Creatures.FlyingSnakeA_Falling.Falling1'
     DeathSound(2)=Sound'TURM_U2Creatures.FlyingSnakeA_DieSoft.DieSoft1'
     DeathSound(3)=Sound'TURM_U2Creatures.FlyingSnakeA_HitHard.Hit2'
     ChallengeSound(0)=Sound'TURM_U2Creatures.FlyingSnakeA_Move.Idle1'
     ChallengeSound(1)=Sound'TURM_U2Creatures.FlyingSnakeA_Move.Idle2'
     ChallengeSound(2)=Sound'TURM_U2Creatures.FlyingSnakeA_Move.Idle3'
     ChallengeSound(3)=Sound'TURM_U2Creatures.FlyingSnakeA_Move.Idle1'
     FireSound=Sound'TURM_U2Creatures.FlyingSnakeA_MeleeDamage.MeleeAttack1'
     ScoringValue=2
     Species=Class'TURM_U2Creatures.SPECIES_Snake'
     ...
     Mesh=SkeletalMesh'TURM_U2Creatures.FlyingSnake'
     DrawScale=0.750000
     Skins(0)=Texture'TURM_U2Creatures.FlyingSnake'
     Skins(1)=Shader'TURM_U2Creatures.FlyingSnakeWings'
