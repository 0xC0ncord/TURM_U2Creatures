...
defaultproperties
{
     BloodDecalClass=Class'TURM_U2Creatures.u2bloodsplatterred'
     Splats(0)=Texture'U2C_SpecialFX.Blood.bloodA_tw256'
     Splats(1)=Texture'U2C_SpecialFX.Blood.bloodB_tw256'
     Splats(2)=Texture'U2C_SpecialFX.Blood.bloodD_tw128'
     ...
     mNumTileColumns=1
     mNumTileRows=1
     Skins(0)=Texture'U2C_SpecialFX.Blood.bloodA_tw256'
     Style=STY_Masked
}
