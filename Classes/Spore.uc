...
{
     Damage=10.000000
     ImpactSoundString="TURM_U2Creatures.SporeA.SporeImpact"
     bMultipleAxes=True
     ...
     StaticMesh=StaticMesh'TURM_U2Creatures.Creatures.Alien_Spore'
     bActorShadows=False
     AmbientSound=Sound'TURM_U2Creatures.SporeA.SporeAmbient_07'
     DrawScale=0.320000
     PrePivot=(Z=2.000000)
     Skins(0)=Shader'TURM_U2Creatures.SporeBug_FX'
