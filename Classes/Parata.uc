...
function PostBeginPlay()
{
    ...
    if (SkinVar <= 0.50)
    {
        Skins[0]=Texture'TURM_U2Creatures.Parata';
    }
    else
    {
        Skins[0]=Texture'TURM_U2Creatures.Parata3';
    }
...
function PlayVictory()
{
    ...
    bShotAnim = true;
        PlaySound(sound'TURM_U2Creatures.FlyingSnakeA_Move.Idle3',SLOT_Interact);
...
function RangedAttack(Actor A)
{
    ...
    if ( Dist < MeleeRange + CollisionRadius + A.CollisionRadius )
    {
        ...
        PlaySound(sound'TURM_U2Creatures.FlyingSnakeA_MeleeDamage.MeleeAttack1', SLOT_Interact);
...
defaultproperties
{
     ...
     ScoringValue=5
     Species=Class'TURM_U2Creatures.SPECIES_Parata'
     ...
     Mesh=SkeletalMesh'TURM_U2Creatures.Parata'
     DrawScale=0.550000
     Skins(0)=Texture'TURM_U2Creatures.Parata'
