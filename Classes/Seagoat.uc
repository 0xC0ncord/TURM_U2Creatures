...
simulated function PostNetBeginPlay()
{
    ...
    if (SkinVar <= 0.30)
    {
        Skins[0]=Shader'TURM_U2Creatures.CharacterMaterials.amphBFinal';
        Skins[1]=Shader'TURM_U2Creatures.CharacterMaterials.amphBFinal';
    }
    else
    {
        Skins[0]=Shader'TURM_U2Creatures.CharacterMaterials.amphAFinal';
        Skins[1]=Shader'TURM_U2Creatures.CharacterMaterials.amphAFinal';
    }
}
...
function BiteDamageTarget()
{
    if ( MeleeDamageTarget(MeleeDamage, (25000 * Normal(Controller.Target.Location - Location))) )
        PlaySound(sound'TURM_U2Creatures.MeleeAttack1', SLOT_Interact);
}
...
function RangedAttack(Actor A)
{
    ...
    if ( Dist < MeleeRange + CollisionRadius + A.CollisionRadius )
    {
        ...
        {*/
            ...
            PlaySound(sound'TURM_U2Creatures.MeleeAttack2', SLOT_Interact);
                //Sleep(0.28)
        //}
        //Controller.bPreparingMove = true;
        bShotAnim = true;
...
defaultproperties
{
     ...
     HitSound(0)=Sound'TURM_U2Creatures.SeagoatA_HitSoft.Hit1'
     HitSound(1)=Sound'TURM_U2Creatures.SeagoatA_HitSoft.Hit2'
     HitSound(2)=Sound'TURM_U2Creatures.SeagoatA_HitSoft.Hit3'
     HitSound(3)=Sound'TURM_U2Creatures.SeagoatA_HitSoft.Hit2'
     DeathSound(0)=Sound'TURM_U2Creatures.SeagoatA_DieHard.DieHard1'
     DeathSound(1)=Sound'TURM_U2Creatures.SeagoatA_DieHard.DieHard2'
     DeathSound(2)=Sound'TURM_U2Creatures.SeagoatA_DieHard.DieHard3'
     DeathSound(3)=Sound'TURM_U2Creatures.SeagoatA_Misc.Idle2'
     ChallengeSound(0)=Sound'TURM_U2Creatures.SeagoatA_Acquire.SeeEnemy1'
     ChallengeSound(1)=Sound'TURM_U2Creatures.SeagoatA_Acquire.SeeEnemy2'
     ChallengeSound(2)=Sound'TURM_U2Creatures.SeagoatA_Acquire.SeeEnemy3'
     ChallengeSound(3)=Sound'TURM_U2Creatures.SeagoatA_Misc.Idle3'
     FireSound=Sound'TURM_U2Creatures.SeagoatA_MeleeMotion.MeleeAttack1'
     ScoringValue=5
     Species=Class'TURM_U2Creatures.SPECIES_Seagoat'
     ...
     Mesh=SkeletalMesh'TURM_U2Creatures.Seagoat'
     DrawScale=0.550000
     Skins(0)=Shader'TURM_U2Creatures.CharacterMaterials.amphAFinal'
     Skins(1)=Shader'TURM_U2Creatures.CharacterMaterials.amphAFinal'
