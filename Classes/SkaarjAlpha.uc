...
function PostBeginPlay()
{
    ...
    bMeleeFighter = true;
        ...
        Skins[0] = Texture'TURM_U2Creatures.MeshU2SkaarjMediumTex0';
        Skins[1] = Texture'TURM_U2Creatures.MeshU2SkaarjMediumTex1';
        Skins[2] = Texture'TURM_U2Creatures.MeshU2SkaarjMediumTex2';
    Skins[3]=Texture'TURM_U2Creatures.skaarjglove';
...
defaultproperties
{
     Species=Class'TURM_U2Creatures.SPECIES_SkaarjAlpha'
     Mesh=SkeletalMesh'TURM_U2Creatures.SkaarjAlpha'
     Skins(0)=Texture'TURM_U2Creatures.MeshU2SkaarjMediumTex0'
     Skins(1)=Texture'TURM_U2Creatures.MeshU2SkaarjMediumTex1'
     Skins(2)=Texture'TURM_U2Creatures.MeshU2SkaarjMediumTex2'
     Skins(3)=Texture'TURM_U2Creatures.skaarjglove'
