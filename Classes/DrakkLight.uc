...
defaultproperties
{
     ...
     BeamEffectClass=Class'TURM_U2Creatures.DrakkLinkBeamEffect'
     ...
     HitSound(0)=Sound'TURM_U2Creatures.Drakk.Hit1'
     HitSound(1)=Sound'TURM_U2Creatures.Drakk.Hit2'
     HitSound(2)=Sound'TURM_U2Creatures.Drakk.Hit3'
     HitSound(3)=Sound'TURM_U2Creatures.Drakk.Hit2'
     DeathSound(0)=Sound'TURM_U2Creatures.Drakk.DieSoft1'
     DeathSound(1)=Sound'TURM_U2Creatures.Drakk.DieSoft2'
     DeathSound(2)=Sound'TURM_U2Creatures.Drakk.DieSoft3'
     DeathSound(3)=Sound'TURM_U2Creatures.Drakk.Idle2'
     ChallengeSound(0)=Sound'TURM_U2Creatures.Drakk.SeeEnemy1'
     ChallengeSound(1)=Sound'TURM_U2Creatures.Drakk.SeeEnemy2'
     ChallengeSound(2)=Sound'TURM_U2Creatures.Drakk.SeeEnemy3'
     ChallengeSound(3)=Sound'TURM_U2Creatures.Drakk.SeeEnemy1'
     FireSound=SoundGroup'WeaponSounds.ShockRifle.ShockRifleAltFire'
     ScoringValue=4
     Species=Class'TURM_U2Creatures.SPECIES_DrakkLight'
     GibGroupClass=Class'TURM_U2Creatures.DrakkDroidGibGroup'
     ...
     AmbientSound=Sound'TURM_U2Creatures.Drakk.Ambient'
     Mesh=SkeletalMesh'TURM_U2Creatures.DrakkLight'
     DrawScale=0.350000
     PrePivot=(Z=-20.000000)
     Skins(0)=Shader'TURM_U2Creatures.Drakk.DrakkLight_AFX'
     Skins(1)=Shader'TURM_U2Creatures.Drakk.DrakkLight_BFX'
     Skins(2)=Shader'TURM_U2Creatures.Drakk.drakkmediumbody3fx'
     SoundVolume=250
