...
defaultproperties
{
     StepSounds(0)=Sound'TURM_U2Creatures.HvyArmorStep1'
     StepSounds(1)=Sound'TURM_U2Creatures.HvyArmorStep2'
     StepSounds(2)=Sound'TURM_U2Creatures.HvyArmorStep3'
     StepSounds(3)=Sound'TURM_U2Creatures.HvyArmorStep4'
     MeleeAnims(0)="MeleeA"
     MeleeAnims(1)="MeleeB"
     MeleeAnims(2)="MeleeC"
     MeleeAnims(3)="MeleeD"
     ...
     GibGroupClass=Class'TURM_U2Creatures.HumanMetalGibGroup'
