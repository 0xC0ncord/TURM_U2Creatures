...
function PlayVictory()
{
    ...
    if (FRand() < 0.5)
        PlaySound(sound'TURM_U2Creatures.Taunt1',SLOT_Interact);
    else
        PlaySound(sound'TURM_U2Creatures.Taunt2',SLOT_Interact);
...
defaultproperties
{
     ...
     MeleeSounds(0)=Sound'TURM_U2Creatures.IzarianA_MeleeDamage.MeleeAttack1'
     MeleeSounds(1)=Sound'TURM_U2Creatures.IzarianA_MeleeDamage.MeleeAttack2'
     MeleeSounds(2)=Sound'TURM_U2Creatures.IzarianA_MeleeDamage.MeleeAttack3'
     MeleeSounds(3)=Sound'TURM_U2Creatures.IzarianA_MeleeDamage.MeleeAttack1'
     bTryToWalk=True
     DodgeSkillAdjust=1.000000
     HitSound(0)=Sound'TURM_U2Creatures.IzarianA_HitSoft.Hit1'
     HitSound(1)=Sound'TURM_U2Creatures.IzarianA_HitSoft.Hit2'
     HitSound(2)=Sound'TURM_U2Creatures.IzarianA_HitHard.Hit3'
     HitSound(3)=Sound'TURM_U2Creatures.IzarianA_HitHard.Hit1'
     DeathSound(0)=Sound'TURM_U2Creatures.IzarianA_DieHard.DieHard1'
     DeathSound(1)=Sound'TURM_U2Creatures.IzarianA_DieHard.DieHard2'
     DeathSound(2)=Sound'TURM_U2Creatures.IzarianA_DieSoft.DieSoft2'
     DeathSound(3)=Sound'TURM_U2Creatures.IzarianA_DieSoft.DieSoft3'
     ChallengeSound(0)=Sound'TURM_U2Creatures.IzarianA_Misc.Idle3'
     ChallengeSound(1)=Sound'TURM_U2Creatures.IzarianA_Misc.Eat1'
     ChallengeSound(2)=Sound'TURM_U2Creatures.IzarianA_Misc.Idle4'
     ChallengeSound(3)=Sound'TURM_U2Creatures.IzarianA_Misc.Idle5'
     ScoringValue=5
     GibGroupClass=Class'TURM_U2Creatures.IzarianGibGroup'
     ...
     ControllerClass=Class'TURM_U2Creatures.IzarianController'
