...
defaultproperties
{
     ...
     FireSound=Sound'TURM_U2Creatures.Drakk.MeleeAttack1'
     ScoringValue=5
     Species=Class'TURM_U2Creatures.SPECIES_DrakkDroid'
     ...
     Mesh=SkeletalMesh'TURM_U2Creatures.DrakkDroid'
     DrawScale=0.550000
     PrePivot=(Z=15.000000)
     Skins(0)=Shader'TURM_U2Creatures.Drakk.drakkdroidFX'
