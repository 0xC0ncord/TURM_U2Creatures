...
simulated function PostNetBeginPlay()
{
    ...
    if (SkinVar <= 0.20)
        Skins[0] = Texture'TURM_U2Creatures.SnipeBloody';
    else if (SkinVar <= 0.40 && SkinVar > 0.20)
        Skins[0] = Texture'TURM_U2Creatures.Snipe';
    else
        Skins[0] = Shader'TURM_U2Creatures.Creatures.SnipeFX';
}
...
function RangedAttack(Actor A)
{
    ...
    if ( Dist < MeleeRange + CollisionRadius + A.CollisionRadius )
    {
        ...
        else
        {
            ...
            PlaySound(sound'TURM_U2Creatures.MeleeAttack3', SLOT_Interact);
...
defaultproperties
{
     ...
     HitSound(0)=Sound'TURM_U2Creatures.SnipeA_HitSoft.Hit1'
     HitSound(1)=Sound'TURM_U2Creatures.SnipeA_HitSoft.Hit2'
     HitSound(2)=Sound'TURM_U2Creatures.SnipeA_HitSoft.Hit3'
     HitSound(3)=Sound'TURM_U2Creatures.SnipeA_HitSoft.Hit2'
     DeathSound(0)=Sound'TURM_U2Creatures.SnipeA_DieHard.DieHard1'
     DeathSound(1)=Sound'TURM_U2Creatures.SnipeA_DieHard.DieHard2'
     DeathSound(2)=Sound'TURM_U2Creatures.SnipeA_DieHard.DieHard3'
     DeathSound(3)=Sound'TURM_U2Creatures.SnipeA_Misc.Idle2'
     ChallengeSound(0)=Sound'TURM_U2Creatures.SnipeA_Misc.Idle3'
     ChallengeSound(1)=Sound'TURM_U2Creatures.SnipeA_Misc.Idle4'
     ChallengeSound(2)=Sound'TURM_U2Creatures.SnipeA_Misc.Idle5'
     ChallengeSound(3)=Sound'TURM_U2Creatures.SnipeA_Misc.Idle6'
     FireSound=Sound'TURM_U2Creatures.SnipeA_MeleeMotion.MeleeAttack1'
     Species=Class'TURM_U2Creatures.SPECIES_Snipe'
     ...
     Mesh=SkeletalMesh'TURM_U2Creatures.Snipe'
     DrawScale=1.750000
